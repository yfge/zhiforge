...
**写完文章后，必须读 `references/anti-ai.md` 逐条过检查。** 该文件包含完整的去 AI 味体系：
- 第零层：5 大根因（均值回归、对称性、情感正确性、无损信息、视角稳定性）
- 第一层：句子级必杀句式（出现即改，零容忍）
- 第二层：段落级病症（节奏均匀、情感弧度、因果链）
- 第三层：全文级病症（信息分布、角色语言、叙述者全知）
- 第四层：气质级人味（粗粝感、偏执、幽默、留白）
- 终极检测流程（5 步扫描）
- 实战对照表（AI版 vs 改良版 vs 爆款版）
...
❌ "不禁……" / "某种程度上" / "那一瞬间"
❌ "这一刻，他/她终于明白了……" / "像是在说给自己听"
❌ "仿佛在无声地诉说着什么" / "空气中弥漫着……的气息"
❌ "时间仿佛在这一刻静止了" / "他/她的眼中闪过一丝……"
```
